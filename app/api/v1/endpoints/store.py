...
from app.core.schemas import STORE_ITEMS, InventoryRead, PurchaseItemData, PurchaseResponse, PurchaseRequest
...
async def purchase_item(
    ...
    """Mua item (hardcode logic như Android)"""
    ...
    # 2. Kiểm tra số dư token của người dùng
    ...
    # 5. Thêm Card vào inventory của người dùng
    ...
    await db.commit()
     ...
     # 6. Response với hardcode item info
    purchased_item = {
